	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		// étape 0 - lecture fichier "db.properties"
	       ...
	       // étape 3 - créer un "statement" (outil pour faire des requêtes)
	        ...
	        int nbLigneAffecter = statement.executeUpdate("UPDATE fournisseur " 
	               + "SET fournisseur.nom =  'La Maison des Peintures' "
                    + "WHERE fournisseur.nom = 'La Maison de la Peinture'");
